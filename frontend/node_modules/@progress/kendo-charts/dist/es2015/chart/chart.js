...
class Chart extends Class {
    ...
    _displayInactiveOpacity(activePoint, multipleSeries, event) {
        ...
        if (multipleSeries) {
            ...
            let inactivePoints;
            let chartInstance = activePoint.parent;
    ...
    _findNewPoint(children, dataItem, series) {
        for (let i = 0; i < children.length; i++) {
            ...
            if (child.children) {
                let result = this._findNewPoint(child.children, dataItem, series);
