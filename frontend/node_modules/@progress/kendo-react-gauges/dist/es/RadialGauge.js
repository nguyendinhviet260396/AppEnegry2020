...
var RadialGauge = /** @class */ (function (_super) {
    ...
    RadialGauge.prototype.render = function () {
        ...
        return (React.createElement(BaseGauge, __assign({}, baseGaugeProps, { deriveOptionsFromParent: this.deriveOptionsFromParent, ref: function (baseGauge) { return _this._baseGauge = baseGauge; }, gaugeConstructor: KendoRadialGauge, getTarget: this.getTarget, wrapperClassName: "k-gauge" }), children));
    };
    /**
