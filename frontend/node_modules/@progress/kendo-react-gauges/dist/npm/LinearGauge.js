...
var LinearGauge = /** @class */ (function (_super) {
    ...
    LinearGauge.prototype.render = function () {
        var _this = this;
        var _a = this.props, children = _a.children, baseGaugeProps = __rest(_a, ["children"]);
        return (React.createElement(BaseGauge_1.BaseGauge, __assign({}, baseGaugeProps, { deriveOptionsFromParent: this.deriveOptionsFromParent, ref: function (baseGauge) { return _this._baseGauge = baseGauge; }, gaugeConstructor: kendo_charts_1.LinearGauge, getTarget: this.getTarget, wrapperClassName: "k-gauge" }), children));
    };
    /**
